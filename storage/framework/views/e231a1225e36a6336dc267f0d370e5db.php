...
<head>
    ...
    <title><?php echo e($appSettings['system_name'] ?? config('app.name', 'NextGen Assets')); ?></title>
                    ...
                    <div class="flex items-center justify-between gap-4 px-4 py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div
                                ...
                                <div class="text-sm font-semibold text-slate-900"><?php echo e(auth()->user()->name ?? 'User'); ?>

                                </div>
                                <div class="text-xs text-slate-500">
                                    <?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->role ?? 'staff'))); ?>
